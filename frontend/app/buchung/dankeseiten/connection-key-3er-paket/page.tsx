...
export default function ConnectionKey3erPaketDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Buchung für das Connection Key 3er-Paket wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                lineHeight: 1.8,
                ...
                Mit dem 3er-Paket erhältst du drei umfassende Connection Key Analysen, die dir helfen, die energetischen Verbindungen in deinen wichtigsten Beziehungen zu verstehen und zu vertiefen.
              </Typography>
            </Box>
