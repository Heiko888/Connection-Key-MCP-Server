...
export default function ConnectionKey5erPaketDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Buchung für das Connection Key 5er-Paket wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                lineHeight: 1.8,
                ...
                Mit dem 5er-Paket erhältst du fünf umfassende Connection Key Analysen, die dir helfen, die energetischen Verbindungen in deinen wichtigsten Beziehungen zu verstehen und zu vertiefen. Das ideale Paket für alle, die ihre Beziehungen auf ein neues Level heben möchten.
              </Typography>
            </Box>
