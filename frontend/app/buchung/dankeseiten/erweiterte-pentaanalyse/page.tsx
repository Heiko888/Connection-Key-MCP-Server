...
export default function ErweitertePentaanalyseDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Buchung für die Erweiterte Pentaanalyse wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                lineHeight: 1.8,
                ...
                Die Erweiterte Pentaanalyse bietet dir einen tiefen Einblick in die Gruppendynamik und Teamenergie deiner wichtigsten Beziehungen. Du wirst verstehen, wie eure Energien zusammenwirken und wie du die Gruppenenergie optimal nutzen kannst.
              </Typography>
            </Box>
