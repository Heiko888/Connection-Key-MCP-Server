...
export default function HumanDesignPlanetsDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Buchung für das Planeten Reading wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                mb: 2,
                ...
                In deinem Planeten Reading erhältst du:
              </Typography>
              <Box component="ul" sx={{ 
                color: 'rgba(255,255,255,0.9)', 
                pl: 3, 
                ...
                <li>Alle Planeten im Human Design</li>
                <li>Astrologische Interpretation</li>
                <li>Planeten-Signaturen</li>
              ...
              <Typography variant="body1" sx={{
                ...
                Wir freuen uns, dich auf deiner Reise zu begleiten und dir zu helfen, die tiefe Bedeutung der Planeten in deinem Human Design zu verstehen.
              </Typography>
            </Box>
