...
export default function PentaEinzelanalyseDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Buchung für die Penta Einzelanalyse wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                lineHeight: 1.8,
                ...
                In deiner Penta Einzelanalyse wirst du die Gruppendynamik und Teamenergie deiner wichtigsten Beziehungen entdecken und verstehen, wie eure Energien zusammenwirken.
              </Typography>
            </Box>
