...
export default function PremiumPentaPaketDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Buchung für das Premium Penta-Paket wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                lineHeight: 1.8,
                ...
                Mit dem Premium Penta-Paket erhältst du umfassende Penta-Analysen für mehrere Gruppen, die dir helfen, die Gruppendynamik und Teamenergie in verschiedenen Bereichen deines Lebens zu verstehen und zu optimieren.
              </Typography>
            </Box>
