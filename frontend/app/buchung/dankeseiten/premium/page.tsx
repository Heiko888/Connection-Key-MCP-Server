...
export default function PremiumDankeseitePage() {
  return (
    <Box sx={{
      minHeight: '100vh',
      background: `
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                Deine Premium-Buchung wurde erfolgreich entgegengenommen. Du erhältst in Kürze eine Bestätigungs-E-Mail mit allen wichtigen Informationen zu deinem Premium Paket.
              </Typography>
              <Typography variant="body1" sx={{
                color: 'rgba(255,255,255,0.9)',
                lineHeight: 1.8,
                ...
                Mit dem Premium Paket erhältst du Zugang zu erweiterten Features und exklusiven Inhalten. Wir freuen uns, dich auf deiner Reise zu begleiten!
              </Typography>
            </Box>
