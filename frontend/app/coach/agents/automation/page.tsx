...
const AutomationAgentPageContent = () => {
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, pt: 2 }}>
        ...
        >
          ...
          >
            Automatisiere deine Workflows mit n8n, erstelle APIs und Webhooks, konfiguriere Server und 
            implementiere CI/CD-Pipelines. Dieser Agent unterstützt dich bei der Entwicklung von 
            Automatisierungslösungen für deine Coach-Arbeit und hilft bei der Integration verschiedener Systeme.
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Stelle dem Agenten Fragen zu n8n-Workflows, API-Design, Webhook-Konfigurationen oder 
