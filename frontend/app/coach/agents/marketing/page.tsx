...
const MarketingAgentPageContent = () => {
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, pt: 2 }}>
        ...
        >
          ...
          >
            Erstelle professionelle Marketingstrategien, Social Media Content, Newsletter, Reels und Funnels. 
            Dieser Agent unterstützt dich bei der Entwicklung von Marketing-Kampagnen, Content-Planung und 
            der Erstellung von ansprechenden Social-Media-Beiträgen für deine Coach-Arbeit.
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Stelle dem Agenten Fragen zu Marketingstrategien, Content-Ideen oder lass dir konkrete Texte und 
            Kampagnen erstellen.
          </Typography>
        </Box>
