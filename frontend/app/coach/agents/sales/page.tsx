    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, pt: 2 }}>
        ...
        >
          ...
          >
            Erstelle überzeugende Verkaufstexte, entwickle Funnels, gestalte die Buyer Journey und 
            nutze Verkaufspsychologie für erfolgreiches Closing. Dieser Agent unterstützt dich bei der 
            Entwicklung von Verkaufsstrategien und der Erstellung von konversionsstarken Texten für 
            deine Coach-Angebote.
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Stelle dem Agenten Fragen zu Verkaufstexten, Funnel-Design, Buyer-Journey-Optimierung oder 
            Closing-Strategien.
          </Typography>
        </Box>
