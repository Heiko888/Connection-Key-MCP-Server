...
const SocialYouTubeAgentPageContent = () => {
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, pt: 2 }}>
        ...
        >
          ...
          >
            Erstelle professionelle YouTube-Video-Skripte, Social-Media-Reels, Posts, Captions und 
            Thumbnail-Ideen. Dieser Agent unterstützt dich bei der Content-Erstellung für YouTube, 
            Instagram, TikTok und andere Social-Media-Plattformen, um deine Coach-Arbeit optimal zu präsentieren.
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Stelle dem Agenten Fragen zu Video-Skripten, Social-Media-Content, Caption-Ideen oder 
            lass dir kreative Thumbnail-Konzepte entwickeln.
          </Typography>
        </Box>
