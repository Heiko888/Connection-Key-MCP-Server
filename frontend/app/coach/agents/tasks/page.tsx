    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, pt: 2 }}>
        ...
        >
          ...
          >
            Übersicht aller Agent-Aufgaben, Statistiken und Ergebnisse. Hier siehst du alle aktiven Agent-Tasks, 
            ihren Status, Fortschritt und Ergebnisse. Verwalte deine AI-Agenten, überwache ihre Performance 
            und analysiere die generierten Inhalte.
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Nutze die Filter und Sortieroptionen, um gezielt nach bestimmten Tasks zu suchen oder den Status zu überprüfen.
          </Typography>
        </Box>
