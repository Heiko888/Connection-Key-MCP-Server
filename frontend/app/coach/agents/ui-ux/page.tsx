/**
 * UI/UX Agent Page (App Router)
 * Route: /coach/agents/ui-ux
 */
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, pt: 2 }}>
        ...
        >
          ...
          >
            Entwickle benutzerfreundliche Interfaces, erstelle Design Systems, gestalte responsive 
            Designs und sorge für Barrierefreiheit. Dieser Agent unterstützt dich bei der Entwicklung 
            von UI/UX-Designs, der Erstellung von Design Systems und der Optimierung der 
            Benutzererfahrung für deine Coach-Anwendungen.
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Stelle dem Agenten Fragen zu UI/UX-Design, Design Systems, Responsive Design oder 
        ...
        >
          <AgentChat agentId="ui-ux" agentName="UI/UX" />
        </Paper>
      </Container>
    </Box>
  );
