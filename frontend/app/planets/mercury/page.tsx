  ...
  if (error) {
    return (
      <Box sx={{ 
        minHeight: '100vh', 
        background: `
          radial-gradient(ellipse 100% 50% at 50% 0%, rgba(135, 206, 235, 0.15) 0%, transparent 70%),
          radial-gradient(ellipse 80% 40% at 20% 100%, rgba(176, 224, 230, 0.12) 0%, transparent 70%),
          radial-gradient(ellipse 60% 30% at 80% 100%, rgba(224, 246, 255, 0.10) 0%, transparent 70%),
  ...
  return (
    <Box sx={{
      ...
      <Container maxWidth="lg" sx={{ padding: 4, position: 'relative', zIndex: 1 }}>
        ...
        {/* Title mit rotierendem Planetensymbol */}
        <motion.div
        ...
        >
          <Box sx={{ textAlign: 'center', marginBottom: 6, position: 'relative' }}>
            {/* Großes rotierendes Merkur-Symbol */}
            <Box sx={{ mb: 3 }}>
              <RotatingPlanetSymbol
                symbol={planetInfo?.symbol || fallbackMercuryInfo.symbol}
                color={planetInfo?.color || fallbackMercuryInfo.color}
            ...
            <Typography 
              ...
              sx={{ 
                ...
                color: '#ffffff',
                textShadow: `
                  0 0 10px ${planetInfo?.color || fallbackMercuryInfo.color},
                  0 0 20px ${planetInfo?.color || fallbackMercuryInfo.color}80,
            ...
            <Typography variant="h5" style={{ color: planetInfo?.color || fallbackMercuryInfo.color, fontStyle: 'italic', fontWeight: 600, mb: 2 }}>
