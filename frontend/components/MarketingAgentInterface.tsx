...
import { Send, User, Loader2, AlertCircle, Sparkles, FileText, Calendar, Mail, TrendingUp, Megaphone, Lightbulb } from 'lucide-react';
...
const marketingTemplates = [
  {
    ...
    description: 'Erstelle einen ansprechenden Social Media Post',
    icon: Sparkles,
    prompt: 'Erstelle einen ansprechenden Social Media Post für Instagram/LinkedIn. Das Thema ist:'
  },
  {
    id: 'email-campaign',
    name: 'Email-Kampagne',
    description: 'Entwickle eine Email-Marketing-Kampagne',
    icon: Mail,
    prompt: 'Erstelle eine Email-Marketing-Kampagne mit Betreff, Einleitung und Call-to-Action. Das Thema ist:'
  },
  {
    id: 'blog-article',
    name: 'Blog-Artikel',
    description: 'Schreibe einen SEO-optimierten Blog-Artikel',
    icon: FileText,
    prompt: 'Erstelle einen SEO-optimierten Blog-Artikel mit Einleitung, Hauptteil und Fazit. Das Thema ist:'
  },
  {
    id: 'ad-copy',
    name: 'Werbetext',
    description: 'Erstelle überzeugende Werbetexte',
    icon: Megaphone,
    prompt: 'Erstelle einen überzeugenden Werbetext mit Headline, Subheadline und Call-to-Action. Das Produkt/Service ist:'
  },
  {
    id: 'content-calendar',
    name: 'Content-Kalender',
    description: 'Erstelle einen Content-Kalender für Social Media',
    icon: Calendar,
    prompt: 'Erstelle einen Content-Kalender für die nächsten 4 Wochen mit Themen, Post-Ideen und Hashtags. Der Fokus liegt auf:'
  },
  {
    id: 'marketing-strategy',
    name: 'Marketing-Strategie',
    description: 'Entwickle eine umfassende Marketing-Strategie',
    icon: TrendingUp,
    prompt: 'Entwickle eine umfassende Marketing-Strategie mit Zielgruppenanalyse, Kanälen, Budget und Zeitplan. Für:'
  }
];

export default function MarketingAgentInterface({
  agentName,
  agentDescription,
  ...
  const handleTemplateClick = (template: { prompt: string; name: string }) => {
    const prompt = `${template.prompt} [Bitte beschreibe dein Thema/Produkt/Service]`;
    sendMessage(prompt);
  };
      ...
      {showTemplates && messages.length <= 1 && (
        <Box sx={{ 
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
            ...
            {marketingTemplates.length > 4 && (
              <Chip
                label="Mehr..."
                onClick={() => {
                  const remainingTemplates = marketingTemplates.slice(4);
          ...
          >
            {message.role === 'assistant' && (
              <Box sx={{
                ...
                <Megaphone size={16} style={{ color: '#ffffff' }} />
              </Box>
            )}
