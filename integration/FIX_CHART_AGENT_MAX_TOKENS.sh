#!/bin/bash
# Fix für Chart Development Agent - maxTokens zu hoch
# Führt zu: "This model's maximum context length is 8192 tokens"

set -e

CONFIG_FILE="/opt/ck-agent/agents/chart-development.json"

echo "🔧 Fix Chart Development Agent - maxTokens"
echo "=========================================="
echo ""
...
# Ersetze maxTokens: 8000 mit maxTokens: 6000
sed -i 's/"maxTokens": 8000/"maxTokens": 6000/' "$CONFIG_FILE"
