/**
 * API Route für Video Creation Agent
 * Route: /api/agents/video-creation-agent
 */

import type { NextApiRequest, NextApiResponse } from 'next';

const MCP_SERVER_URL = process.env.MCP_SERVER_URL || 'http://138.199.237.34:7000';
const AGENT_ID = 'video-creation-agent';
...
export default async function handler(
  ...
  try {
    ...
    console.error('Video Creation Agent API Error:', error);
