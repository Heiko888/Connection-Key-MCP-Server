#!/bin/bash
# Einfacher Fix: Chart-Daten aus Reading-Text extrahieren
...
echo "🔧 Fix: Chart-Daten aus Reading extrahieren"
echo "==========================================="
echo ""
...
# Finde calculateViaReadingAgent und füge extractChartDataFromReading hinzu
# Erstelle temporäre Datei
TEMP_FILE=$(mktemp)

# Kopiere alles bis zum Ende der Klasse
awk '
/^class ChartCalculationService/ { inClass = 1 }
inClass {
    print
